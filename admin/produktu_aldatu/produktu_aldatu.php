...
<head>
    ...
    <title>Produktuak - Aldatzea</title>
</head>
    ...
    <form method="post" action="index.php">
        ...
        <table cellspacing="5" cellpadding="5" border="1">
            <tr>
                ...
                <td><input type="text" name="marka" value="<?php echo htmlspecialchars($marka) ?>"></td>
            </tr>
            <tr>
                <td align="right">Modeloa:</td>
                <td><input type="text" name="modeloa" value="<?php echo htmlspecialchars($modeloa) ?>"></td>
            </tr>
            <tr>
                <td align="right">Gama:</td>
                <td><input type="text" name="gama" value="<?php echo htmlspecialchars($gama) ?>"></td>
            </tr>
            <tr>
                <td align="right">Prezioa:</td>
                <td><input type="text" name="prezioa" value="<?php echo htmlspecialchars($prezioa) ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="deskontua" value="<?php echo htmlspecialchars($deskontua) ?>"></td>
            </tr>
            <tr>
